...
const elements = {
    ...
    topLogoDepth: document.getElementById('topLogoDepth'),
...
async function handleSubmit() {
    ...
    formData.append('top_logo_depth', elements.topLogoDepth ? elements.topLogoDepth.value || elements.logoDepth.value : elements.logoDepth.value);
